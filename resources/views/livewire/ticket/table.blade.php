                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('ticket.edit', $ticket['id']) }}"><i
                                                ...
                                                Edit</a>
                                            <a class="dropdown-item" href="{{ route('ticket.delete', $ticket['id']) }}"><i
                        ...
                        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                            <ul class="pagination">
                                <li class="paginate_button page-item previous @disabled($currentPage == 1)" id="DataTables_Table_0_previous">
                                    <button wire:click="changePage({{ $tickets['current_page'] - 1 }})" @disabled($currentPage == 1) aria-controls="DataTables_Table_0" aria-role="link" data-dt-idx="previous" class="page-link">
                                        Previous
                                    </button>
                                </li>

                                @for ($i = 1; $i <= $tickets['last_page']; $i++)
                                    <li class="paginate_button page-item {{ $tickets['current_page'] == $i ? 'active' : ''  }}">
                                ...
                                <li class="paginate_button page-item next @disabled($tickets['last_page'] == $currentPage)" id="DataTables_Table_0_next">
                                    <button wire:click="changePage({{ $tickets['current_page'] + 1 }})" @disabled($tickets['last_page'] == $currentPage) aria-controls="DataTables_Table_0" aria-role="link" data-dt-idx="next" class="page-link">
                                        Next
                                    </button>
                                </li>
                            </ul>
