<div class="card mb-4">
    <h5 class="card-header">Airport List</h5>
    <hr class="mt-0">
                ...
                <table class="datatables-ajax table dataTable no-footer" id="DataTables_Table_0"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="sorting {{ $sortBy == "city" ? 'sorting_'.$sortDirection : '' }}" wire:click="sortBy('city')" aria-controls="DataTables_Table_0">
                                City
                            </th>
                    ...
                    <tbody>
                        @forelse ($airports['data'] as $airport)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('airport.edit', $airport['id']) }}"><i
                                                    class="ti ti-pencil me-1"></i>
                                                Edit</a>
                                            <a class="dropdown-item" href="{{ route('airport.delete', $airport['id']) }}"><i
                        ...
                        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                            <ul class="pagination">
                                <li class="paginate_button page-item previous @disabled($currentPage == 1)" id="DataTables_Table_0_previous">
                                    <button wire:click="changePage({{ $airports['current_page'] - 1 }})" @disabled($currentPage == 1) aria-controls="DataTables_Table_0" aria-role="link" data-dt-idx="previous" class="page-link">
                                        Previous
                                    </button>
                                </li>

                                @for ($i = 1; $i <= $airports['last_page']; $i++)
                                    <li class="paginate_button page-item {{ $airports['current_page'] == $i ? 'active' : ''  }}">
                                ...
                                <li class="paginate_button page-item next @disabled($airports['last_page'] == $currentPage)" id="DataTables_Table_0_next">
                                    <button wire:click="changePage({{ $airports['current_page'] + 1 }})" @disabled($airports['last_page'] == $currentPage) aria-controls="DataTables_Table_0" aria-role="link" data-dt-idx="next" class="page-link">
                                        Next
                                    </button>
                                </li>
                            </ul>
